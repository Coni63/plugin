...
//**************commerce color******************
	...
	function Update(elem, index){
		...
		elem.onkeyup=function(){
			document.getElementById('label'+index).innerHTML = Create_Aff(elem.value.replace(/[^0-9]/gi,''),type_conversion);
...
if (Path =='uebersicht.php' || Path =='islandview.php' || Path =='weltkarte.php' || Path =='allianceoverview.php' || Path =='highscore.php' || Path =='postfach.php' || Path =='premium.php'){
	DO_boost();
	DO_commerce_link();
	Display_conversion();
	DO_safe_attaque();
