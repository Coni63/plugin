...
Add.innerHTML ='<table class="battleReport" width="100%">'
	...
	+ '<tr>'
		+ '<td>' 
			+'<span class="tooltipExtention showTooltipDefault" title="Cout : '+ Convert(Perte_Munition_Attaquant * 10, 'Argent')+'" data="'+Convert(Perte_Munition_Attaquant * 10, 'Argent')+'">Munitions : '
	...
	+ '<tr>'
		+ '<td>'
			+'<span class="tooltipExtention showTooltipDefault" title="Cout : '+Convert(Perte_Diesel_Attaquant * 7040, 'Argent')+ ' ( '+ Convert(Perte_Diesel_Attaquant*7040*0.6, 'Petrole') + ' avec Vladimir)" data="'+Convert(Perte_Diesel_Attaquant * 7040, 'Argent')+' ( '+ Convert(Perte_Diesel_Attaquant*0.6*7040, 'Petrole') + ' avec Vladimir) ">Diesel : ' 
	...
	+ '<tr>'
		+ '<td>'
			+'<span class="tooltipExtention showTooltipDefault" title="Cout : '+Convert(Perte_Kerosene_Attaquant * 7040*2, 'Argent')+ ' ( '+ Convert(Perte_Kerosene_Attaquant*7040*2*0.6, 'Petrole') + ' avec Vladimir)" data="'+Convert(Perte_Kerosene_Attaquant * 7040*2, 'Argent')+' ( '+ Convert(Perte_Kerosene_Attaquant*0.6*2*7040, 'Petrole') + ' avec Vladimir) ">Kérosène : ' 
